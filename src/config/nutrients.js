...
export const NUTRIENT_COLUMNS = [
  ...
  { key: 'vitD',        name: '비타민D',    rda: 10,    unit: 'μg',      aliases: ['비타민D', '비타민 D', '비타민D3', '비타민 D3', '비타민D2', '비타민 D2', '콜레칼시페롤', '에르고칼시페롤'] },
  { key: 'vitE',        name: '비타민E',    rda: 11,    unit: 'mg α-TE', aliases: ['비타민E', '비타민 E', '토코페롤'] },
  { key: 'vitK',        name: '비타민K',    rda: 70,    unit: 'μg',      aliases: ['비타민K', '비타민 K'] },
  { key: 'niacin',      name: '나이아신',   rda: 15,    unit: 'mg NE',   aliases: ['나이아신', '니아신', '나이아신아마이드', '니코틴산아미드', '니코틴아미드', '비타민B3', '비타민 B3'] },
  { key: 'folate',      name: '엽산',       rda: 400,   unit: 'μg DFE',  aliases: ['엽산', '폴산', '폴레이트', '비타민B9', '비타민 B9'] },
  { key: 'pantothenic', name: '판토텐산',   rda: 5,     unit: 'mg',      aliases: ['판토텐산', '판토텐', '비타민B5', '비타민 B5'] },
  { key: 'biotin',      name: '비오틴',     rda: 30,    unit: 'μg',      aliases: ['비오틴', '비타민B7', '비타민 B7', '비타민H'] },
